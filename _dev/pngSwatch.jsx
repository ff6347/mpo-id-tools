// awesome scirpt by jongware
// http://forums.adobe.com/thread/780105
...
var win = function win(colors){
// UI
//----------------------------------------------------------
var w = new Window("dialog", "Tint 2 Swatch");
     var ddl = w.add("dropdownlist",[0,0,200,10]);
...
var colorize = function color (sel) {

    // the color
    // the selected colorswatch
    var c = doc.swatches.item(sel);
